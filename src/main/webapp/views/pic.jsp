...
<div class="col-sm-8 text-left">
    ...
    <%--  촬영되어 저장된 사진 중 서버로 imgname 만 전송  --%>
    ...
    <%-- 출력 결과 아래  --%>
    <h2> 1 emotion : 당신의 표정은 ${result.emotion} </h2>  <%--   --%>
    <h2> 2 gender : 당신의 성별은  ${result.gender} </h2>
    <h2> 3 pose : 당신이 취한 자세는 ${result.pose} </h2>
    <h2> 4 age : 당신의 얼굴 나이는 ${result.age} </h2>
</div>